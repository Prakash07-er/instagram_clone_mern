        ...
        <div className="home">
            {
                data.map(item => {
                    ...
                    return (
                        ...
                        <h2><img src={item.postedBy.name===state.name?state.pic:"https://res.cloudinary.com/dj0pjewbs/image/upload/v1622694190/blank-profile-picture-973460_1280_ciyd1m.png"} className="home_profile_pic" /> <Link to={item.postedBy._id !== state._id ? `/profile/${item.postedBy._id}` : "/profile"} className="card_heading" >{item.postedBy.name} </Link>  </h2> 
